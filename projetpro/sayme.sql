...
-- Généré le :  Jeu 12 Mars 2020 à 11:52
...
--
-- Structure de la table `cathusers`
--
...
--
-- Contenu de la table `cathusers`
--

INSERT INTO `cathusers` (`id`, `name`) VALUES
(1, 'standard'),
(2, 'intermédiaire'),
(3, 'administrateur');
...
INSERT INTO `users` (`id`, `lastname`, `firstname`, `email`, `password`, `id_cathusers`) VALUES
...
(4, 'Albrecht', 'Stéphanie', 'albrecht.stephanie@outlook.fr', '$2y$10$8cDv5TuiavhAxwq20foH8.o7VRh4jylrMztwWFr01AkVBfxKIbpM6', 1),
...
--
-- Index pour la table `cathusers`
--
ALTER TABLE `cathusers`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `users`
  ADD PRIMARY KEY (`id`),
  ADD KEY `users_cathusers_FK` (`id_cathusers`);
...
--
-- AUTO_INCREMENT pour la table `cathusers`
--
ALTER TABLE `cathusers`
...
--
ALTER TABLE `users`
  ADD CONSTRAINT `users_cathusers_FK` FOREIGN KEY (`id_cathusers`) REFERENCES `cathusers` (`id`);
