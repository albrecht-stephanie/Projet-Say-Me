...
<body>
  ...
  <div class="container d-flex justify-content-around">
    <div class="row">
      <!--card-->
      <div class="card col-lg-3 offset-1">
      ...
      <div class="card col-lg-3 offset-1">
        <div class="card-header">
          <h3>Samsung Galaxy S20 Ultra 5G 128 Go</h3>
        </div>
        <div class="card-body">
          <a href="https://www.frandroid.com/produits/smart/smartphones/661244-samsung-galaxy-s20-ultra"
            title="lien vers frandroid"><img src="assets/img/samsung-galaxy-s20-ultra.jpg" alt="Samsung S20"></a>
          <p>Ecran Infinity Quad HD+, 120 Hz, Dynamic AMOLED – 16M de couleurs, Gorilla Glass 6, Filtre de lumière
            bleue, Always On Display.
            <details>
              <summary>lire plus...</summary>
              Caméra frontale : 10 MP Dual Pixel, Ouverture f/2.2, Autofocus, HDR10+, Contrôle par mouvement, Contrôle
              ...
              Empreinte digitale, Gyroscope, Mémoire RAM : 12 Go, Double port SIM hybride + E-SIM,
              Thèmes personnalisables, Fond d’écran photo ou vidéo, Reconnaissance faciale, Haut-parleurs stéréo AKG,
        ...
        <div class="card-footer">
          <a class="btn btn-info" href="#Samsung Galaxy S20 Ultra" title="views">Voir les avis</a>
          <a class="btn btn-success" href="addreview.php" role="button">Déposer un avis</a>
        </div>
      </div>
      <!--card-->
      <div class="card col-lg-3 offset-1">
        <div class="card-header">
          <h3>Acer Predator Helios PH315-52-54FD Ordinateur portable Gaming 15.6"</h3>
        </div>
        <div class="card-body">
          <a href="https://www.acer.com/ac/fr/FR/content/predator-model/NH.Q54EF.035" title="lien vers Samsung">
            <img src="assets/img/pc-predator.jpg" alt="pc-predator"></a>
          <p class="card-text">Compacte, solide, performant et favorable à l'upgrade, l'Acer Predator Helios PH315-52-54FD avance quelques arguments convaincants, <br></p>
          <details>
            <summary>lire plus...</summary>
            <p>Compacte, solide, performant et favorable à l'upgrade, l'Acer Predator Helios PH315-52-54FD avance quelques arguments convaincants, 
            sans parler de sa carte graphique récente GeForce GTX 1660 Ti qui offre une niveau de jeu haut de gamme. Derrière son look racé aux accents bleutés, 
            il installe également une base correcte partagée entre un Quad Core i5 et un stockage basique de 1 To avec 8 Go de RAM. 
            L'écran IPS borderless apporte sa part d'immersion tandis que le système de refroidissement a été retravaillé au service de l'efficacité. 
            Le package est convaincant, à condition de passer outre l'absence de SSD, sa connectique mal organisée et son écran de fréquence basique.
            </p>
          </details>
        </div>
        <div class="card-footer">
          <a class="btn btn-info" href="#pc-predator" title="views">Voir les avis</a>
          <a class="btn btn-success" href="addreview.php" role="button">Déposer un avis</a>
        </div>
      </div>
      <!--end card-->
        ...
        <div class="card col-lg-4 offset-1">
          ...
          <div class="card-body">
            <p class="card-text">Excellent. Je recommande. Comment dire ? Une révolution. Bon, elle coûte chère mais
              ...
              rattrape largement les précédéceurs.</p>
          </div>
          <div class="card-footer" id="rating">
            <h4>Note:
              <i class="fa fa-star"></i>
    ...
    <div id="scroll_to_top"> 
          <a href="#top"><img src="assets/img/fleche_haut.ico" alt="Retourner en haut" /></a> 
        </div>
